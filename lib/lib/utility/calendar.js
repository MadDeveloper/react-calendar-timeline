...
function iterateTimes(start, end, unit, utcOffset, timeSteps, callback) {
  var time = (0, _moment2.default)(start).utcOffset(utcOffset).startOf(unit);
  ...
  while (time.valueOf() < end) {
    var nextTime = (0, _moment2.default)(time).utcOffset(utcOffset).add(timeSteps[unit] || 1, unit + 's');
