  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function infoLabel() {
      var _props = this.props,
          ...
          infoLabelFormat = _props.infoLabelFormat,
          _state = this.state,
          dragTime = _state.dragTime,
          resizeTime = _state.resizeTime,
          dragGroupTitle = _state.dragGroupTitle;

      var label = dragTime || resizeTime;
      var labelComplement = dragTime ? ' - ' + dragGroupTitle : '';
      var computedLabel = (0, _moment2.default)(label).utcOffset(utcOffset).format(infoLabelFormat) + labelComplement;

      return label && _react2.default.createElement(_InfoLabel2.default, { label: computedLabel });
    }
  }, {
    key: 'header',
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          canvasTimeEnd = _state2.canvasTimeEnd;
      var _state3 = this.state,
          dimensionItems = _state3.dimensionItems,
          height = _state3.height,
          groupHeights = _state3.groupHeights,
...
ReactCalendarTimeline.propTypes = {
  ...
  applyLocalOffset: _propTypes2.default.bool,
  infoLabelFormat: _propTypes2.default.string,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getTimeFromRowClickEvent = function (e) {
    ...
    var _state5 = _this4.state,
        ...
        canvasTimeEnd = _state5.canvasTimeEnd;
